...
const recentPosts: BlogPost[] = [
    ...
    },
    {
        ...
        excerpt:
            "The digital landscape has transformed how we create and consume written content. Here's what writers should focus on.",
    ...
    },
    {
        ...
        excerpt:
            "Understanding how narratives work can help you create more engaging and impactful content.",
        author: "George Orwell",
        date: "Apr 12, 2025",
        readTime: "8 min read",
        coverImage:
            "https://images.unsplash.com/photo-1516414447565-b14be0adf13e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80",
                ...
                <section className="py-16 bg-primary/10">
                    <div className="container-custom text-center">
                        ...
                        <p className="text-lg mb-8 max-w-2xl mx-auto">
                            Join our community of writers and readers. Create,
